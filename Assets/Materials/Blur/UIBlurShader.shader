Shader "Hidden/UIBlurShader"
{
  Properties {
    ...
    _Radius ("Circle Radius", Range(0, 1)) = 1
    ...
    SubShader {
      ...
      Pass {
        ...
        v2f vert (appdata_t v) {
          ...
          // Calculate the distance of the vertex from the center of the UI element
          float2 center = float2(0.5, 0.5); // Assuming the UI element is centered
          o.dist = length(o.uv - center);
